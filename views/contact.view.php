    ...
    <section>
        <div class="container px-6 py-12 mx-auto">
            <div>
                ...
                <p class="mt-3 text-gray-500 ">We’d love to hear from you. Please fill out this form or shoot us an
                    email.</p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                    ...
                    <span class="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80 ">
                        ...
                        <h2 class="mt-4 text-base font-medium ">Office</h2>
                        <p class="mt-2 text-sm ">Come say hello at our office HQ.</p>
                        <p class="mt-2 text-sm ">100 Smith Street Collingwood VIC 3066 AU</p>
                    </div>
                ...
                <div class="p-4 py-6 rounded-lg bg-gray-50  md:p-8">
                    <form>
                        ...
                        <button class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                            Send message
                        </button>
                    </form>
                </div>
